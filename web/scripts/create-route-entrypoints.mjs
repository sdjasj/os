...
const projectSlugs = ['os', 'pdf-library', 'cubesandbox', 'e2b', 'minimind', 'ray', 'strix', 'arvo', 'mini-swe-agent', 'openhands', 'codex', 'openclaw', 'hands-on-modern-rl', 'verl', 'deepspeed', 'megatron-lm', 'pwn-college']
