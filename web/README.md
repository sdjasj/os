...
- CubeSandbox、E2B、MiniMind、Ray、Strix、ARVO、mini-SWE-agent、OpenHands、Codex、Pi、OpenClaw、Hands-On Modern RL、verl、DeepSpeed、Megatron-LM 与非官方 pwn.college 中文教程：合计 296 篇源码/研究/实践教程；
