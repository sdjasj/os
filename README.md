...
本项目保存了南京大学 JYY《操作系统原理（2026 春）》公开课程页面的资料快照，并在其 30 讲课程讲义与 9 个 MiniLab 的基础上整理了一套面向实践的中文教程。教程同时提供逐讲详解和按知识依赖重组的主题版，两者共享一组可运行实验。
...
- [前端阅读网站](web/README.md)：课程地图、三栏长文阅读器、全文搜索、深色模式与本地学习进度。
